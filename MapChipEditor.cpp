...
#pragma endregion
	...
	if (ImGui::TreeNode("MapChipEditor")) {
		...
		// ドロップダウンメニューの表示
		static const char* stage[] = { "stage_1", "stage_2", "stage_3", "stage_4","stage_5","stage_6","stage_7","stage_8","stage_9","stage_10","stage_11","stage_12","stage_13","stage_14","stage_15","stage_16" };
