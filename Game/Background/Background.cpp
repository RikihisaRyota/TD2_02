...
void Background::Update() {
	...
	if (time_>= kMaxTime) {
		...
		particleMotion->color.startColor = { rnd_.NextFloatRange(0.0f,0.02f),rnd_.NextFloatRange(0.0f,0.02f),rnd_.NextFloatRange(0.0f,0.01f),rnd_.NextFloatRange(0.0f,0.5f) };
		particleMotion->color.endColor = { rnd_.NextFloatRange(0.0f,1.0f),rnd_.NextFloatRange(0.0f,0.0f),rnd_.NextFloatRange(0.0f,0.1f),rnd_.NextFloatRange(0.0f,0.0f) };
		particleMotion->color.currentColor = particleMotion->color.startColor;
		particleMotion->scale.startScale = { 40.0f,40.0f,40.0f };
